...
if __name__ == "__main__":
    ...
    parser.add_argument('--value_learning_rate', type=float, default=0.05, help='0.05')
    parser.add_argument('--additional_term_learning_rate', type=float, default=0.00, help='0.03')
    ...
    parser.add_argument('--max_iteration', type=int, default=1e3, help='1e3')
    ...
    parser.add_argument('--prob_intensity', type=float, default=0.3, help='the intensity of probing noise = 0.3')
    parser.add_argument('--base_decline', type=float, default=-0.000, help='the decline of probing noise = -0.002')
    # Initial state
    ...
    parser.add_argument('--print_interval', type=int, default=20)  # 20

    ################################################
    # 8. Data savings
    parser.add_argument('--save_folder', type=str, default=None)
    # Save value/policy every N updates
    parser.add_argument('--apprfunc_save_interval', type=int, default=1e3,
