...
def init_args(env, **args):
    ...
    if args['action_type'] == 'continu' or args['action_type'] == 'with_adv':  # get the dimension of continuous action or the num of discrete action
    ...
    if hasattr(env, 'constraint_dim'):  # get the dimension of constraint
        args['constraint_dim'] = env.constraint_dim
    if hasattr(env, 'adversary_dim'):  # get the dimension of adversary
        args['adversary_dim'] = env.adversary_dim
